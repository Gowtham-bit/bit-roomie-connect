...
async function startServer() {
  try {
    ...
    console.error(
      `👉 Please update the MONGODB_URI in "backend/.env" with your valid MongoDB Atlas connection string.`,
    );
    console.error(
      `   Example: MONGODB_URI=mongodb+srv://<username>:<password>@cluster0.mongodb.net/bit_roomie_connect?retryWrites=true&w=majority\n`,
    );
  }
}
