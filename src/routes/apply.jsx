  ...
  head: () => ({
    meta: [
      { title: "Hostel Application · BIT Hostel Portal" },
      {
        name: "description",
        content:
          "Submit your BIT hostel application with personal, parent, medical and document details.",
      },
      ...
      <form
        onSubmit={(e) => {
          ...
          toast.success("Application submitted", {
            description: "Track the status from your dashboard.",
          });
        }}
          ...
          <section className="rounded-2xl border bg-card p-6 shadow-soft">
            ...
            <div className="mt-4 grid gap-4 sm:grid-cols-2">
              {[
                ...
                ["Register number", currentStudent.regNo],
                ["Department", currentStudent.department],
                ["Year", String(currentStudent.year)],
                ["Gender", currentStudent.gender],
                ["Mobile number", currentStudent.mobile],
              ].map(([l, v]) => (
              ...
              <div className="space-y-2 sm:col-span-2">
                ...
                <div className="flex flex-wrap gap-2">
                  {[
                    ...
                    <label
                      key={f}
                      className="flex cursor-pointer items-center gap-2 rounded-xl border px-3 py-2 text-sm hover:border-primary/40"
                    >
          ...
          <section className="rounded-2xl border bg-card p-6 shadow-soft">
            ...
            <div className="mt-4 space-y-3">
              {[
                ...
                <label
                  key={d}
                  className="flex cursor-pointer items-center justify-between rounded-xl border border-dashed px-4 py-3 text-sm hover:border-primary/50"
                >
                  <span>{d}</span>
