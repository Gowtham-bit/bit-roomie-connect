      ...
      <div className="grid gap-5 lg:grid-cols-[1.4fr_1fr]">
        ...
        >
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="space-y-2">
              ...
              <Input defaultValue={currentStudent.hostel ?? ""} readOnly />
            </div>
            <div className="space-y-2">
              <Label>Current room</Label>
              <Input defaultValue={currentStudent.room ?? ""} readOnly />
            </div>
            <div className="space-y-2">
          ...
          <div className="space-y-2">
            ...
            <Textarea rows={4} required placeholder="Explain why you need a different room" />
          </div>
        ...
        <section className="rounded-2xl border bg-card p-6 shadow-soft">
          ...
          <ol className="mt-5 space-y-6 border-l pl-5">
            {[
              ["Submitted", "31 Jul 2026", true],
              ["Warden review", "In progress", true],
              ["Admin approval", "Pending", false],
              ["Room allotted", "Pending", false],
            ].map(([s, d, active]) => (
