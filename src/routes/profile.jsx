...
function Page() {
  ...
  return (
    <AppShell
      ...
      actions={
        <>
          <Button variant="outline" onClick={() => toast("Password reset link sent")}>
            Change password
          </Button>
      ...
      <div className="grid gap-5 lg:grid-cols-[1fr_2fr]">
        <section className="rounded-2xl border bg-card p-6 text-center shadow-soft">
          ...
          <div className="mt-4 flex flex-wrap justify-center gap-2">
            <Badge>{currentStudent.dept || currentStudent.department || "CSE"}</Badge>
        ...
        <div className="space-y-5">
          {[
            ...
            [
              ...
              [
                ["Department", currentStudent.department || currentStudent.dept || "—"],
